...
ROOM_TEXT["fr"].update({
    ...
    "role_ready": "Ton rôle est prêt", "role_ready_help": "Appuie seulement quand tu es prêt à le regarder en privé.",
    "reveal_my_role": "Voir mon rôle",
    "role_rules": "Règles et cas particuliers",
    "eliminated_summary": "Voir le bilan de la partie en temps réel",
    "hide_my_role": "Masquer mon rôle", "show_my_role": "Afficher mon rôle",
    "show_role_details": "Voir les pouvoirs et les cas particuliers", "hide_role_details": "Masquer les pouvoirs et les cas particuliers",
...
ROOM_TEXT["en"].update({
    ...
    "role_ready": "Your role is ready", "role_ready_help": "Only tap when you are ready to view it privately.",
    "reveal_my_role": "View my role",
    "role_rules": "Rules and special cases",
    "eliminated_summary": "View the live game summary",
    "hide_my_role": "Hide my role", "show_my_role": "Show my role",
    "show_role_details": "View powers and special cases", "hide_role_details": "Hide powers and special cases",
...
ROOM_TEXT["tn"].update({
    ...
    "role_ready": "Role mte3ek 7adher", "role_ready_help": "Enzel ken ki tkoun wa7dek w prêt bech tchoufou.",
    "reveal_my_role": "Chouf role mte3i",
    "role_rules": "El règles w les cas particuliers",
    "eliminated_summary": "T7eb tchouf el bilan en temps reel?",
    "hide_my_role": "5abbi el role", "show_my_role": "Warri el role",
    "show_role_details": "Chouf el pouvoir w les cas particuliers", "hide_role_details": "5abbi el pouvoir w les cas particuliers",
...
ROOM_HISTORY_TEXT = {
    "fr": {
        ...
        "story_servant_inherited": "{name} a quitté le rôle de Servante et a pris le rôle {role}.",
        ...
        "outcome_eliminated": "Élimination", "outcome_tie": "Égalité", "outcome_skipped": "Vote passé", "outcome_forced_transition": "Fin manuelle", "pyro_action_douse": "Asperger", "pyro_action_ignite": "Incendier", "pyro_action_skipped": "Tour passé", "pyro_action_blocked": "Bloqué par le Cerbère", "winner_wolves": "Loups-Garous", "winner_village": "Village", "winner_white_wolf": "Loup Blanc", "winner_angel": "Ange", "winner_alien": "Alien", "winner_pyromaniac": "Pyromane", "winner_couple": "Couple", "winner_draw": "Égalité — aucun vainqueur", "not_recorded": "Non renseigné", "archive": "Archives des parties", "room_label": "Partie", "narrated_by_you": "narrée par toi", "narrated_by": "narrée par", "narrator_unknown": "narrateur non renseigné",
    },
    "en": {
        ...
        "story_servant_inherited": "{name} left the Servant role and took the role {role}.",
        ...
        "outcome_eliminated": "Elimination", "outcome_tie": "Tie", "outcome_skipped": "Vote skipped", "outcome_forced_transition": "Manual ending", "pyro_action_douse": "Douse", "pyro_action_ignite": "Ignite", "pyro_action_skipped": "Turn skipped", "pyro_action_blocked": "Blocked by Cerberus", "winner_wolves": "Werewolves", "winner_village": "Village", "winner_white_wolf": "White Wolf", "winner_angel": "Angel", "winner_pyromaniac": "Arsonist", "winner_couple": "Couple", "winner_draw": "Draw — no winner", "not_recorded": "Not recorded", "archive": "Game archive", "room_label": "Game", "narrated_by_you": "narrated by you", "narrated_by": "narrated by", "narrator_unknown": "narrator not recorded",
    },
    "tn": {
        ...
        "story_servant_inherited": "{name} ma3adech Servante w 5dhet role {role}.",
        ...
        "outcome_eliminated": "Joueur 5raj", "outcome_tie": "Égalité", "outcome_skipped": "Vote t3adda", "outcome_forced_transition": "Nhar tsakker manuellement", "pyro_action_douse": "Rach zit", "pyro_action_ignite": "Cha3el", "pyro_action_skipped": "Passa tour", "pyro_action_blocked": "Cerbere blockeh", "winner_wolves": "El loups", "winner_village": "El Village", "winner_white_wolf": "Loup Blanc", "winner_angel": "Ange", "winner_alien": "Alien", "winner_pyromaniac": "Pyromane", "winner_couple": "El Couple", "winner_draw": "Égalité — 7ad ma rba7", "not_recorded": "Ma t7attetch", "archive": "Archive mta3 les games", "room_label": "Game", "narrated_by_you": "enti narritha", "narrated_by": "narreha", "narrator_unknown": "el narrateur mahouche ma3rouf",
    },
}
...
def public_event_details(state, event_type):
    ...
    if event_type == "night":
        ...
        return {
            ...
            "ancient_resisted": player_label(state, state.get("ancientResistedPlayerId")),
            "deaths": death_names,
            ...
            "seer_actor": player_label(state, state.get("seerActorId")),
    ...
    return {
        ...
        "servant": player_label(state, state.get("servantPlayerId")),
        "servant_inherited_role": state.get("servantInheritedRole") if state.get("servantInheritedRole") in ROLE_KEYS else None,
...
def room_history_list(request):
    if not request.user.is_authenticated:
        return redirect("home")
    rooms = GameRoom.objects.select_related("narrator").annotate(event_count=Count("events", distinct=True))
